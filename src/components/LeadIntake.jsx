  ...
  const goToNextStep = (newStep) => () => {
    ...
    switch (currentStep) {
      case 1:
        ...
        break;
      case 2:
        isValid = validateInput('homeOwnership');
        break;
      case 3:
...
const LeadIntakeHero = () => {
  ...
  const validateInput = (field, value) => {
    ...
    if (!value.trim()) {
      ...
      // Remove the error state after the animation
      setTimeout(() => {
  ...
  const renderStepContent = () => {
    if (formSubmitted) {
      ...
      return (
        ...
        formData={formData}
        validateInput={validateInput} // Ensure this is passed if used within StepForm
      />
